//typforge0.0.1\crates\typforge\src\editor\editor_panel\render.rs
use crate::editor::{CodeEditor, DraggedTab, EditorPanel, FileContentUpdated, TabDrag};
use gpui::*;
use gpui_component::popover::Popover;
use gpui_component::{h_flex, scroll::ScrollableElement, ActiveTheme, StyledExt};
    ...
    for EditorPanel<W>
{
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            // Clear hover state on parent level mouse down, leaving nested editor text inputs fully interactive
            .on_mouse_down(
                MouseButton::Left,
